...
main (int argc, char **argv)
{
	...
	if (!svc_register(transp, CALC_PROG, CALC_VER, calc_prog_1, IPPROTO_UDP)) {
		fprintf (stderr, "%s", "unable to register (CALC_PROG, CALC_VER, udp).");
		exit(1);
	}
	...
	if (!svc_register(transp, CALC_PROG, CALC_VER, calc_prog_1, IPPROTO_TCP)) {
		fprintf (stderr, "%s", "unable to register (CALC_PROG, CALC_VER, tcp).");
		exit(1);
	}
